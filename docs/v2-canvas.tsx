    ...
    return (
      <Stack gap={16}>
        ...
        <Table
          ...
          rows={[
            ["0", "Branch", "Git history is the August snapshot. No second product.", "Start"],
            ...
            ["11–12", "CJSJ manuscript + Zenodo", "2–3 pages, IEEE citations, teacher form. No ESA zip on Zenodo.", "Deadline"],
          ]}
          rowTone={[
            "info",
            "danger",
