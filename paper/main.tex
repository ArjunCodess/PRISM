...
Honest metrics, the residual candidate, and the two-part floor candidate were scored on the frozen 18 August split; the product specification and exhibit UI were left alone.
...
Next measurements are split-conformal coverage; a frozen official-test evaluation; a dilution-gap probe for H4; and repeated grouped splits so horizon gaps also carry intervals.
